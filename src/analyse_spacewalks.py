...
plt.tight_layout()
plt.savefig(f'{output_dir}/fig_cumulative_hours.png', dpi=150)
plt.close()
...
plt.tight_layout()
plt.savefig(f'{output_dir}/fig_duration_distribution.png', dpi=150)
plt.close()
...
plt.tight_layout()
plt.savefig(f'{output_dir}/results/figures/fig_top_astronauts.png', dpi=150)
plt.close()
